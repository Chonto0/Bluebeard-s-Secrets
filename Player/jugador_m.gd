...
func _player_death():
	...
	anim.play("Morir")  # Reproducir la animación de muerte
...
func _on_death_animation_complete():
	...
	get_tree().change_scene_to_file("res://Player/muerte.tscn")

func player():
	pass

func _on_hitbox_jugador_body_entered(body):
	if body.has_method("enemy"):
		enemy_inattack_range = true
		enemy = body  # Guarda la referencia al enemigo

func _on_hitbox_jugador_body_exited(body):
	if body.has_method("enemy"):
